  ...
  return (
    <Html>
      <Head>
        ...
        <link rel="icon" type="image/png" href="/logos/lcai.png" />
        <link rel="shortcut icon" href="/logos/lcai.png" />

        <meta name="application-name" content={APP_NAME} />
        <meta name="keywords" content={APP_NAME + ' LCAI Token Bridge Interchain App'} />
